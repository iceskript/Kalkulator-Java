...
public class Kalkulator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtxtHasil.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        getContentPane().add(jtxtHasil, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 310, 50));
        ...
        getContentPane().add(jbtnPM, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 70, 50));
        ...
        getContentPane().add(jbtnBS, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, 70, 50));
        ...
        getContentPane().add(jbtnCE, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, 70, 50));
        ...
        getContentPane().add(jbtnC, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 160, 70, 50));

        jButton5.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton5.setText("jButton1");
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 70, 50));
        ...
        getContentPane().add(jbtnPlus, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 220, 70, 50));
        ...
        getContentPane().add(jbtnDigit7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, 70, 50));
        ...
        getContentPane().add(jbtnDigit8, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 70, 50));
        ...
        getContentPane().add(jbtnDigit9, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 220, 70, 50));

        jButton10.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton10.setText("jButton1");
        getContentPane().add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 220, 70, 50));
        ...
        getContentPane().add(jbtnDigit5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 280, 70, 50));

        jbtnMin.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jbtnMin.setText("-");
        ...
        getContentPane().add(jbtnMin, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 280, 70, 50));
        ...
        getContentPane().add(jbtnDigit6, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 280, 70, 50));
        ...
        getContentPane().add(jbtnDigit4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 280, 70, 50));

        jButton15.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton15.setText("jButton1");
        getContentPane().add(jButton15, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 280, 70, 50));
        ...
        getContentPane().add(jbtnDigit1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 340, 70, 50));
        ...
        getContentPane().add(jbtnEquals, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 340, 70, 50));
        ...
        getContentPane().add(jbtnDigit3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 340, 70, 50));
        ...
        getContentPane().add(jbtnDigit2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 340, 70, 50));

        jButton20.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton20.setText("jButton1");
        getContentPane().add(jButton20, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 340, 70, 50));
        ...
        getContentPane().add(jbtnDigit0, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 400, 70, 50));
        ...
        getContentPane().add(jbtnDiv, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 400, 70, 50));

        jbtnCA.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jbtnCA.setText("=");
        ...
        getContentPane().add(jbtnCA, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 400, 70, 50));
        ...
        getContentPane().add(jbtnDot, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, 70, 50));

        jButton25.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton25.setText("jButton1");
        getContentPane().add(jButton25, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 400, 70, 50));
        ...
        jLabel2.setText("PRESENTASI KELOMPOK 7 ");
    ...
    {
        String Nums = jtxtHasil.getText() + q;
        jtxtHasil.setText(Nums);
    }
    ...
    private void jbtnEqualsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnEqualsActionPerformed
        NumEnter1 = Double.parseDouble(jtxtHasil.getText());
        jtxtHasil.setText("");
        Op = "*";
    ...
    private void jbtnPMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnPMActionPerformed
        double nums = Double.parseDouble(String.valueOf(jtxtHasil.getText()));
        nums = nums * (-1);
        jtxtHasil.setText(String.valueOf( nums));
    ...
    private void jbtnCAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCAActionPerformed
       NumEnter2 = Double.parseDouble(jtxtHasil.getText());
       if (Op == "+")
       {
    ...
    private void jbtnDotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDotActionPerformed
        if (! jtxtHasil.getText().contains("."))
        {
            jtxtHasil.setText(jtxtHasil.getText() + jbtnDot.getText());
        }
    ...
    private void jbtnBSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBSActionPerformed
        String backSp = null;
        if (jtxtHasil.getText().length() > 0)
        {
            StringBuilder sb = new StringBuilder(jtxtHasil.getText());
            sb.deleteCharAt(jtxtHasil.getText().length() - 1);
            backSp = sb.toString();
            jtxtHasil.setText(backSp);
        }
